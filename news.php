...
require "header.php";
 ?>
 <main class="single-page news-page">
                            ...
                            <ul class="p-0">
                                ...
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    ...
                                    <div class="entry-content">
                                        ...
                                        <div class="posted-date">March 10, 2019</div>
                                    </div>
                                </li>
                                ...
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    ...
                                    <div class="entry-content">
                                        ...
                                        <div class="posted-date">March 09, 2019</div>
                                    </div>
                                </li>
                            </ul>
                        </div><!-- .cat-links -->
                            ...
                            <ul class="p-0">
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    ...
                                    <div class="entry-content">
                                        ...
                                        <div class="post-metas d-flex flex-wrap align-items-center">
                                            <span class="posted-date"><a href="#">Jul 25, 2019</a></span>
