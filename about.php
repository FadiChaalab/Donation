...
require "header.php";
 ?>
 <main class="single-page about-page">
                ...
                <div class="col-12 col-lg-6 order-2 order-lg-1">
                    <div class="welcome-content">
                        <header class="entry-header">
                            <h1 class="entry-title">Wellcome to our Charity</h1>
                        </header><!-- .entry-header -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="circular-progress-bar">
                        <div class="circle">
                          <div class="chart" data-percent="70" data-scale-color="#ffb400">70%</div>
                            <strong class="d-flex justify-content-center"></strong>
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="circular-progress-bar">
                        <div class="circle">
                          <div class="chart" data-percent="65" data-scale-color="#ffb400">65%</div>
                            <strong class="d-flex justify-content-center"></strong>
                        </div>
